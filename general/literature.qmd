...
- [Zed](https://zed.dev/): A modern, fast code editor built in Rust with built-in AI assistant support. Recommended for this course. Offers a [free student tier](https://zed.dev/education) with code completion and API credits when you sign up with a university email.
...
- [Mistral Vibe](https://mistral.ai/vibe): Mistral's open-source CLI coding agent. It scans your project’s file structure and Git status, supports natural language commands, and can modify and execute changes across multiple files. Included in the [Mistral Student subscription](https://help.mistral.ai/en/articles/347553-as-a-student-am-i-eligible-for-a-discount-on-le-chat-pro).
