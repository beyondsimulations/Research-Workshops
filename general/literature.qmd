...
## Local LLMs and data tools

These tools let you run open-source models on your own machine or feed your own documents into an LLM. Running locally gives you more privacy and control, but requires a decent GPU for larger models.
