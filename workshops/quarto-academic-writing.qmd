...
Use [Zotero](https://www.zotero.org/) (free) with the [Better BibTeX](https://retorque.re/zotero-better-bibtex/) extension to manage your references. Better BibTeX auto-exports your library to a `.bib` file, so the workflow becomes: save a paper to Zotero, cite it in Quarto with `[@key]`. See the [Literature Research](../workshops/literature-research.qmd) workshop for detailed setup instructions.
