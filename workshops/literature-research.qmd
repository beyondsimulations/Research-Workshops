---
title: "Lecture - Structured Literature Research"
subtitle: "Seminar Preparation"
author: "Dr. Tobias Vlćek"
format:
  html:
    output-file: literature-research-page.html
---
...
[Google Scholar](https://scholar.google.com/) is the most accessible starting point -- free, broad coverage, easy to use.
...
4. **Auto-export** a `.bib` file with Better BibTeX
...
:::{.callout-tip}
A good literature review is not about reading everything — it is about finding and connecting the right papers.
:::
...
5. **Organize** — Store everything in Zotero with Better BibTeX
